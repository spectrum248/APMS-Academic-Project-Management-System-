<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Guide_home.aspx.cs" Inherits="apms_app_.Account.Guide.Guide_home" %>
...
<body>
    ...
    <header><form id="form2" runat="server">
      ...
      <div class="container-fluid">
          <div class="demo-nav-wrapper">
              ...
              <div class="collapse navbar-collapse" id="demo-menu">
                  ...
                  <h5 style="color:black;">Guide Section</h5>&nbsp&nbsp&nbsp
                  <ul class="nav navbar-nav">
                      ...
                      &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<asp:Button ID="Button4" runat="server" Text="SignOut" CssClass="btn  btn-lg btn-outline-primary btn-white" Onclick="SignOut_Click"/>
                  </ul>
                  </div>
          </div>
      </div>
        ...
        <div class="content-box">
            ...
            <div class="container">
                <div class="row wow animated fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                   ...
                   <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" CssClass="btn  btn-lg btn-outline-primary btn-white" Text="Edit Profile" />
                         </div>
                        </div>
                    </div>
                    <div class="container">
                <div class="row wow animated fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                    ...
                    <div id="home-btn" class="animated zoomIn">
                        ...
                        <asp:Button ID="Button5" CssClass="btn  btn-lg btn-outline-primary btn-white" runat="server" OnClick="Button5_Click" Text="View Groups" />
                    </div>
