<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="co_home.aspx.cs" Inherits="apms_app_.Account.Coordinator.co_home" %>
...
<body data-spy="scroll" data-target=".fixed-top" data-offset="65">
    <header><form id="form1" runat="server">
      ...
      <div class="container-fluid">
          <div class="demo-nav-wrapper">
              ...
              <div class="collapse navbar-collapse" id="demo-menu">
                  ...
                  <h5 style="color:black;">Coordinator Section</h5>&nbsp&nbsp&nbsp
                  <ul class="nav navbar-nav">
                      ...
                      &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<asp:Button ID="Button4" CssClass="btn  btn-lg btn-outline-primary btn-white" runat="server" Onclick="SignOut_Click" Text="SignOut" />
                  </ul>
                  </div>
          </div>
      </div>
                    ...
                    <div class="col-md-4">
                        <div class="service-item">
                            ...
                            <div class="service-item-description">
                                <p>Coordinator can edit profile here.</p>
                                <br />
                            </div>
                    <div id="home-btn" class="animated zoomIn">
        <asp:Button ID="Profile_btn" runat="server" OnClick="Button1_Click" CssClass="btn  btn-lg btn-outline-primary btn-white" Text="Edit Profile" />
                    </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row wow animated fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                    ...
                    <div id="home-btn" class="animated zoomIn">
        <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" CssClass="btn  btn-lg btn-outline-primary btn-white" Text="Allocate" />
                    </div>
                        </div>
                    </div>
                ...
                <div class="row wow animated fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                    <div class="col-md-4">
                        <div class="service-item">
                            ...
                            <div class="service-item-description">
                                <p>Coordnators can find previous projects here.</p>
                                <br />
                            </div>
                    <div id="home-btn" class="animated zoomIn">
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" CssClass="btn  btn-lg btn-outline-primary btn-white" Text="History" />
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="img-wrapper">
                            <a href="img/work/work1.JPG" title="work desc">
                                <img src="img/work/work1.JPG" class="img-responsive" alt="work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="img-wrapper">
                            <a href="img/work/work2.JPG" title="work desc">
                                <img src="img/work/work2.JPG" class="img-responsive" alt="work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="img-wrapper">
                            <a href="img/work/work3.JPG" title="work desc">
                                <img src="img/work/work3.JPG" class="img-responsive" alt="work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="img-wrapper">
                            <a href="img/work/work4.JPG" title="work desc">
                                <img src="img/work/work4.JPG" class="img-responsive" alt="work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="img-wrapper">
                            <a href="img/work/work5.JPG" title="work desc">
                                <img src="img/work/work5.JPG" class="img-responsive" alt="work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="img-wrapper">
                            <a href="img/work/work6.JPG" title="work desc">
                                <img src="img/work/work6.JPG" class="img-responsive" alt="work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="img-wrapper">
                            <a href="img/work/work7.JPG" title="work desc">
                                <img src="img/work/work7.JPG" class="img-responsive" alt="work">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="img-wrapper">
                            <a href="img/work/work8.JPG" title="work desc">
                                <img src="img/work/work8.JPG" class="img-responsive" alt="work">
                            </a>
                        </div>
                    </div>
